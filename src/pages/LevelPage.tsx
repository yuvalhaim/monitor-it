    ...
    <div dir="rtl" style={S.page}>
      ...
      <style>{`
        ...
        @media(max-width:600px){
          ...
          .level-top-row      { flex-direction:column!important; }
          .level-top-row > *  { width:100%!important; min-width:0!important; box-sizing:border-box; }
          .level-ts-card { padding:10px 14px!important; flex-direction:row!important; align-items:center!important; flex-wrap:wrap!important; gap:4px 14px!important; justify-content:flex-start!important; }
          .level-ts-card > div:nth-child(1) { margin-bottom:0!important; }
          .level-ts-card > div:nth-child(1) span { font-size:14px!important; }
          .level-ts-card > div:nth-child(2) { font-size:24px!important; }
          .level-ts-card > div:nth-child(3) { font-size:24px!important; margin-top:0!important; }
          .level-ts-card > div:nth-child(4) { margin-top:0!important; }
